...
| `create_event` | Core | Create calendar events |
| `update_event` | Core | Update existing calendar events |
| `delete_event` | Core | Delete calendar events by ID |
| `rsvp_event` | Core | Respond to calendar invitations |
